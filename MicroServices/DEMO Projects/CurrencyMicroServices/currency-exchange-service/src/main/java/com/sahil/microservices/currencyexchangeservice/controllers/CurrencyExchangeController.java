package com.sahil.microservices.currencyexchangeservice.controllers;
...
import com.sahil.microservices.currencyexchangeservice.dao.CurrencyExchangeRepository;
...
public class CurrencyExchangeController {
	...
	public CurrencyExchange retrieveExchangeValue(@PathVariable String from, @PathVariable String to) {
		...
		// CurrencyExchange(1000L,from,to,BigDecimal.valueOf(56));
